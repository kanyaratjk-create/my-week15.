...
<div class="container py-5" style="margin-top: 90px; max-width: 1200px;">
    ...
    <div class="d-flex align-items-center gap-3 mb-4">
        <span class="category-tag">Articles Management</span>
                    ...
                    <tbody>
                        @foreach ($blogs as $item)
                            <tr>
                                ...
                                <td>
                                    @if ($item->status)
                                        <a href="{{ route('author.blog.changeStatus', $item->id) }}" class="badge-status-published">
                                            <span class="badge-dot badge-dot-green"></span>
                                            เผยแพร่
                                        </a>
                                    @else
                                        <a href="{{ route('author.blog.changeStatus', $item->id) }}" class="badge-status-draft">
                                ...
                                <td>
                                    <a href="{{ route('author.blog.edit', $item->id) }}" class="badge-status-edit">
                                        <span class="badge-dot badge-dot-orange"></span>
                                        แก้ไข
                                    </a>
                                </td>
                                <td>
                                    <a href="{{ route('author.blog.delete', $item->id) }}"
